...
<head>
    ...
    <title>Timeout - Texas City Snapshot</title>
    <link
    ...
    <div id="main" class="container">
        <div class="row">
            <div class="col-sm">
                ...
                <p>One or more requests to external services for weather or traffic camera data took too long. Try your
                    request again in a minute.</p>
            </div>
        </div>
        <footer class="pt-4">
